    ...
    <section data-anim-wrap class="masthead -type-5 mt-50">
        ...
        <div class="pl-45 pr-30">
            <div class="row y-gap-50 items-center">
                <div class="row">
                    <div class="col-12">
                        <h2 class="text-center text-24 text-red-1">SUCCESSFUL CANDIDATES FOR ADMISSION INTO JSS1 IN COMMAND SECONDARY SCHOOLS 2025/2026 ACADEMIC SESSION IS OUT.</h2>
                        <br/>
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-4 col-12">
                                <h6 class="text-center text-17 text-red-1">COMMAND SCIENCE SECONDARY SCHOOL LISTS</h6>
                                <br/>
                                <table class="table table-bordered table-striped table-responsive">
                                    <thead>
                                    <tr>
                                    ...
                                    @foreach($csss as $dss)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ Str::upper($dss['name']) }}</td>
                                            <td><a  href="{{ $dss['url'] }}" target="_blank" class="button px-25 h-50 -purple-1 text-white ml-20">Download Result</a> </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
