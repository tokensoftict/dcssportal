                ...
                <form class="contact-form respondForm__form row y-gap-20 pt-30" wire:submit.prevent="generateReport">
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <select  name="gender" wire:model.defer="center" class="text-16 lh-1 fw-500 text-dark-1 mb-10">
                        ...
                        <div class="col-3">
                            ...
                            <select  name="gender" wire:model.defer="school" class="text-16 lh-1 fw-500 text-dark-1 mb-10">
                        ...
                        <div class="col-3">
                            ...
                            <select  name="gender" wire:model.defer="payment_status" class="text-16 lh-1 fw-500 text-dark-1 mb-10">
                        ...
                        <div class="col-3">
                            ...
                            <div wire:loading.remove wire:target="generateReport">
                                <button type="submit" class="button -md -blue-1 align-content-center text-white fw-500 w-1/4">Download Excel</button>
                            </div>
                        </div>
