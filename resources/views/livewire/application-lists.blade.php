                            ...
                            <table class="table" style="width: 100%">
                                ...
                                @foreach($this->pendingApplications as $pendingApplication)
                                    <tr class="text-12">
                                        ...
                                        <td  class="text-center"><a target="_blank" href="{{ route('administrator.view_application', ['email'=>$pendingApplication->email]) }}"><img class="img-thumbnail img-fluid" style="width: 80px" alt="{{ $pendingApplication->fullname  }}" src="{{ url('/'.$pendingApplication->passport_path)  }}" width="150"/></a></td>
