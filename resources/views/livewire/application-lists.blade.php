                ...
                <div class="tabs__content py-30 px-30 js-tabs-content">
                        ...
                        <table class="table" style="width: 100%">
                            ...
                            @foreach($this->pendingApplications as $pendingApplication)
                                <tr class="text-12">
                                    ...
                                    <td  class="text-center"><img class="img-thumbnail img-fluid" style="width: 80px" alt="{{ $pendingApplication->fullname  }}" src="{{ url('/passport/'.$pendingApplication->passport_path)  }}" width="150"/> </td>
                    ...
                    <div class="tabs__pane -tab-item-2">
                        ...
                        @foreach($this->completedApplications as $completedApplication)
                            <tr class="text-12">
                                <td  class="text-center">{{ $loop->iteration }}</td>
                                <td  class="text-center"><img class="img-thumbnail img-fluid" style="width: 80px" alt="{{ $completedApplication->fullname  }}" src="{{ url('/passport/'.$completedApplication->passport_path)  }}" width="150"/> </td>
                                ...
                                <td  class="text-center">
                                    <a target="_new" href="{{ route('account.download_photocard',$completedApplication->id) }}" class="button text-13 -sm -light-7 -dark-bg-dark-2 text-blue-1">Download Photo Card</a>
                                </td>
                            </tr>
                        @endforeach
                            </tbody>
