            ...
            <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 p-40">
                <div class="row justify-between items-center pb-20 y-gap-20" style="padding: 20px;">
                    <div class="col-md-auto">
                        ...
                        <h2 class="text-17 lh-1 fw-500">School Summary Report</h2>
                    </div>
                    <div class="col-md-5">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="px-30 py-30 rounded-16 border-light -dark-border-dark-1 shadow-2 h-100 custom-card">
                                <div class="d-flex justify-between items-center mb-20">
                                    <div class="text-17 fw-500 text-dark-1">{{ $school->name }}</div>
                                    <div class="d-flex justify-center items-center size-40 rounded-full bg-blue-1-05">
                                        <i class="icon-online-learning text-16 text-blue-1"></i>
                                    </div>
                                </div>
                                ...
                                <div class="row y-gap-20">
                                    <div class="col-4">
                                        ...
                                        <div class="text-18 lh-1 fw-700 text-dark-1 mt-5">{{ $school->total_apps }}</div>
                                    </div>
                                    <div class="col-4">
                                        <div class="text-14 lh-1 fw-500 text-light-1">Paid</div>
                                        <div class="text-18 lh-1 fw-700 text-blue-1 mt-5">{{ $school->completed_apps }}
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="text-14 lh-1 fw-500 text-light-1">Pending</div>
                                        <div class="text-18 lh-1 fw-700 text-purple-1 mt-5">{{ $school->pending_apps }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-25">
                                    <div class="d-flex justify-between items-center mb-10">
                                        ...
                                        <div class="text-13 lh-1 fw-500 text-dark-1">
                                            {{ $school->total_apps > 0 ? round(($school->completed_apps / $school->total_apps) * 100) : 0 }}%
                                        </div>
                                    </div>
                                    <div class="progress-bar rounded-full bg-light-3" style="height: 6px;">
                                        <div class="progress-bar__content rounded-full bg-blue-1"
                                            style="width: {{ $school->total_apps > 0 ? ($school->completed_apps / $school->total_apps) * 100 : 0 }}%; height: 100%;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="col-12">
                            <div class="text-center py-50">
                                ...
                                <div class="text-18 fw-500 text-light-1">No schools found matching your search.</div>
                            </div>
                        </div>
                    @endforelse
                </div>
