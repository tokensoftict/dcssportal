        ...
        <div class="col-12">
            <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100 p-3">
                <form class="contact-form respondForm__form row y-gap-20 pt-30" wire:submit.prevent="generateReport">
                    <div class="row items-center y-gap-20">

                        <div class="col-md-6 col-12">
                            <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Search Applicant (Email, Surname, First Name, Othernames, Telephone, Exam Number)</label>
                            <input type="text" name="search" wire:model.debounce.500ms="search" placeholder="Type here to search..." class="text-16 lh-1 fw-500 text-dark-1 mb-10 form-control" style="border: 1px solid #ccc; padding: 10px; border-radius: 8px; width: 100%;">
                        </div>

                        <div class="col-md-4 col-12">
                            <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Payment Status</label>
                            <select name="payment_status" wire:model="payment_status" class="text-16 lh-1 fw-500 text-dark-1 mb-10 form-select" style="border: 1px solid #ccc; padding: 10px; border-radius: 8px; width: 100%;">
                        ...
                        <div class="col-md-2 col-12 pt-20">
                        ...
                        @foreach($applications as $application)
                            <tr class="text-12">
                                ...
                                <td class="text-center">
                                    <a target="_blank" href="{{ route('administrator.view_application', ['email'=>$application->email]) }}">
                                        <img class="img-thumbnail img-fluid" style="width: 80px" alt="{{ $application->fullname }}" src="{{ url('/'.$application->passport_path) }}" width="100"/>
                                    </a>
                                </td>
